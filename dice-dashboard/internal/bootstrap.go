...
func SetupRouter() *gin.Engine {
	...
	api := router.Group("/api")
	{
		...
		api.GET("/cluster-stats", apiHandler.GetClusterStats)
		api.GET("/metrics-history", apiHandler.GetMetricsHistory)
		...
		api.POST("/demo/fail/:node", apiHandler.FailNode)
		api.POST("/demo/recover/:node", apiHandler.RecoverNode)
		api.POST("/demo/latency/:node", apiHandler.InjectLatency)
		api.POST("/demo/latency-clear/:node", apiHandler.ClearLatency)
